...
git clone https://github.com/furzeface/JS-Snippets ~/Library/Application\ Support/Sublime\ Text/Packages/User/JS
...
git clone https://github.com/joshnh/CSS-Snippets ~/Library/Application\ Support/Sublime\ Text/Packages/User/CSS
