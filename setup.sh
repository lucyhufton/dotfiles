...
hdiutil mount /Users/admin/puppet-agent-1.2.4-1.yosemite.dmg
sudo installer -pkg /Volumes/puppet-agent-1.2.4-1.yosemite/puppet-agent-1.2.4-1.yosemite.pkg -target /
